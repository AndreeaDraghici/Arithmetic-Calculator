...
public class Calculator {
    ...
    private void initialize() {
        ...
        btnAdditon.addActionListener(this::actionAddition);
        ...
        btnMultiply.addActionListener(this::actionMultiplication);
        ...
        btnSubstraction.addActionListener(this::actionSubstraction);
        ...
        btnDivision.addActionListener(this::actionDivision);
        ...
        btnReset.addActionListener(this::actionMessages);
        ...
        btnCompare.addActionListener(e -> CompareTwoNumbers.main(null));
    ...
    private void actionDivision(ActionEvent e) {
    ...
    private void actionSubstraction(ActionEvent e) {
    ...
    private void actionMessages(ActionEvent e) {
    ...
    private void actionAddition(ActionEvent e) {
    ...
    private void actionMultiplication(ActionEvent e) {
